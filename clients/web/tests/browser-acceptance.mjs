   ...
   await page.route("**/api/v2/**",async route=>{
    ...
    if(path.endsWith("/sunshine/devices")){
     if(req.method()==="POST"){
      ...
      const device={id:randomUUID(),name:req.postDataJSON().name,registered:false,pairing_pending:true,revoked:false,agent_online:false,sunshine_reachable:null,configuration_state:"unknown",snapshot:null,capabilities:null,last_seen_at_micros:null};
