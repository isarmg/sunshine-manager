...
Only after `verify-import` reports `exact_match: true`, enable the Sunshine
worker bundled into the selected Union release and Union's private gateway
adapter. Keep the old
