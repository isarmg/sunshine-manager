...
[精确提交的双平台检查](https://github.com/isarmg/sunshine-manager-server/actions/runs/34084295438) 已通过。
[同一提交的主 CI](https://github.com/isarmg/sunshine-manager-server/actions/runs/34084274813) 已通过。
...
最终附件应来自[候选标签检查](https://github.com/isarmg/sunshine-manager-server/actions/runs/34084882407)的成功作业，
