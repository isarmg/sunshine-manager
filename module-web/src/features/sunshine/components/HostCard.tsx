...
export function HostCard({ host, selected, updating, canWrite, canManage, onOpen, onDelete, onInlineUpdate }: {
    ...
    >
      <CardInner>
        ...
        <CardActions>
          ...
          <button type="button" className="sarmg-card__action sarmg-action-danger" disabled={editingDisabled} onClick={onDelete}>
